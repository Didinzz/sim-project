 ...
 @section('title', 'Surat Belum Di Acc')
 @section('belumAcc', 'bg-gray-300 dark:bg-gray-700')

 @section('content')
 @if (session()->has('accTTD'))
        <div id="toast-success"
            ...
            <div class="ms-3 text-sm font-normal">{{ Session('accTTD') }}</div>
            <button type="button"
    ...
    @endif
     <div
         ...
         <div class="w-full mb-1">
             <div class="mb-4">
                 <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Surat Yang Belum Ditanda Tangani</h1>
             </div>
                                     ...
                                     <td class="p-4 space-x-2 whitespace-nowrap text-center">
                                         ...
                                         @if($m->status_persetujuan == 'diajukan')
                                             <a href="{{ url('diterima/' .$m->id) }}"
                                                 ...
                                                 <i class="fa-solid fa-eye mr-2"></i> Acc Surat
                                             </a>
