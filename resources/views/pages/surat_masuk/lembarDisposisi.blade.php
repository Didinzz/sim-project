            ...
            <table style="width: 100%;">
                <tr>
                    ...
                    <td style="width: 100%; ">
                        ...
                        <h1 style="font-weight: bold;" class="text-center">SMK NEGERI 3 GORONTALO</h1>
                        <p style="font-size: 12px;" class="text-center">
                            Jl. Ternate Telp (0435)822772 Fax : (0435)822772 Kota Gorontalo 96125
                        </p>
                        <p style="font-size: 12px;" class="text-center">
                            Website: <i style="color: red">smkn3gorontalo.sch.id</i> E-mail :
                            <u style="color: blue">smkn3gtlo@yahoo.co.id</u>
                        </p>
                    </td>
