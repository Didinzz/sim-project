 ...
 @section('title', 'Total Surat Yang Belum Di Ajukan')
 ...
 @section('content')
     ...
     <div
         ...
         <div class="w-full mb-1">
             <div class="mb-4">
                 <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Table Surat Yang belum di Ajukan</h1>
             </div>
             <div class="sm:flex space-between">
                 <div class="items-center mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                     <form class="lg:pr-3" action="{{ url('Total_surat_belum') }}" method="GET">
