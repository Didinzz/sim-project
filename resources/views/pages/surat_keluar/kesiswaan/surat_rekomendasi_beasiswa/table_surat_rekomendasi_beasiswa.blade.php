 ...
 @section('rekomBeasiswa', 'bg-gray-300 dark:bg-gray-700')
 ...
 @section('content')
     ...
     <div
         ...
         <div class="w-full mb-1">
             <div class="mb-4">
                 <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Table Surat Rekomendasi
                     Beasiswa
                 </h1>
             </div>
             <div class="sm:flex space-between">
                 <div class="items-center mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0 dark:divide-gray-700">
                     <form class="lg:pr-3" action="{{ url('siswa-surat-rekomendasi-beasiswa') }}" method="GET">
                 ...
                 <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                     ...
                     <a href="{{ route('form-siswa-surat-rekomendasi-beasiswa') }}" type="button"
