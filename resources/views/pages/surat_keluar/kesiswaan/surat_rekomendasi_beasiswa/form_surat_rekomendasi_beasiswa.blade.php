...
@section('content')
    ...
    <section
        ...
        <form action="{{ route('store-siswa-surat-rekomendasi-beasiswa') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-span-6 sm:col-span-3">
                 ...
                 <div class="col-span-6 sm:col-span-3 hidden">
                    ...
                    <input id="text" name="tipeSurat" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 focus:border-slate-500  focus:outline-none focus:ring" value="Surat Rekom Beasiswa">
                </div>
            ...
            <div class=" p-6 w-70">
                <h2 class="text-2xl font-bold text-black text-left capitalize mb-5 dark:text-white">Surat Rekomendasi Beasiswa</h2>
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        <label for="first-name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Program Beasiswa</label>
