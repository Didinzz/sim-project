...
@section('title', 'Form Surat Keterangan')
@section('content')
    <!-- component -->
    <section
        ...
        <form action="{{ route('store-siswa-surat-keterangan') }}" method="POST" enctype="multipart/form-data">
            ...
            <hr class="font-bold broder-t-4 mb-2 mt-4 border-y-black dark:border-gray-300">

            <h2 class="text-2xl font-bold text-black text-left capitalize mb-5 mt-5 dark:text-white">Surat Keterangan
            </h2>
            ...
            <div class=" p-6 w-70">
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                            for="emailAddress">Tangal
                            Surat</label>
                        <input id="text" name="tanggalSurat" type="date" min="{{ now()->format('Y-m-d') }}"
                            value="{{ now()->format('Y-m-d') }}"
                            class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 focus:border-slate-500  focus:outline-none focus:ring"
            ...
            <hr class="font-bold broder-t-4 mt-2 border-y-black dark:border-gray-300">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="kelasjurusan" id="first-name"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Kelas/Jurusan" required>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="first-name"
                    ...
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <textarea name="keterangan"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            id="catatan" cols="10" rows="3" required>Bahwa nama di atas adalah benar - benar siswa SMK Negeri 3 Gorontalo dan Aktif
