...
@section('title', 'Form Surat Pensiun Dini')
@section('content')
    <!-- component -->
    <section
        ...
        <form action="{{ route('store-pegawai-surat-pensiun') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input required id="passwordConfirmation" name="perihal" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" placeholder="Perihal">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                        for="passwordConfirmation">Nomor Petunjuk</label>
                    <input required id="passwordConfirmation" name="petunjuk" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" placeholder="Nomor Petunjuk">
                </div>
                <div class="col-span-6 sm:col-span-3">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                        for="passwordConfirmation">Nomor Paket</label>
                    <input required id="passwordConfirmation" name="nomor_paket" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" placeholder="Nomor Paket">
                </div>
            ...
            <div class=" w-full">
                <h2 class="text-2xl font-bold text-black text-left capitalize mb-5 dark:text-white">Surat Pensiun Dini</h2>
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="golongan" value="Pembina Tingkat I/IV B" id="first-name"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="first-name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unit
                            Organisasi</label>
                        <input type="text" name="unit" id="first-name"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Unit Organisasi" required>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="first-name"
                ...
                <h2 class="text-2xl font-bold text-black text-left capitalize mb-5 mt-5 dark:text-white">Alasan Pensiun
                </h2>
                <hr class="font-bold broder-t-4 mb-4 border-y-black dark:border-gray-300">
                ...
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-6">
                        ...
                        <textarea name="keterangan"
                            ...
                            id="catatan" cols="10" rows="3" required>Dengan ini mengajukan PERMOHONAN PENSIUN DINI sebagai PNS terhitung mulai tanggal 02 Mei 2022 dengan alasan sudah tidak dapat melaksanakan tugas mengajar karena sakit.

2. Dengan ini saya menyatakan bahwa sebelum menerima keputusan persetujuan pensiun dini, maka saya akan tetap melaksanakan tugas dan kewajiban saya sebagai PNS.

3. Demikian surat permohonan pensiun dini ini saya buat untuk dapat dipergunakan sebagaimana mestinya.  </textarea>
                    </div>
                </div>
                ...
                <div class="flex justify-end mt-6">
                    <div class="flex justify-end mt-6">
                <button
                    class="px-6 py-2 leading-5 text-white font-bold transition-colors duration-200 transform bg-blue-600 rounded-md hover:bg-blue-800 focus:outline-none focus:blue-gray-600"><i class="fa-solid fa-plus mr-1 mx-auto"></i>Buat Surat</button>
            </div>
            </div>
        </form>
