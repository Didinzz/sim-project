 ...
 @section('content')
     <div
         ...
         <div class="w-full mb-1">
             <div class="mb-4">
                 <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Table Surat Tugas Guru</h1>
             </div>
             <div class="sm:flex space-between">
                 ...
                 <div class="flex items-center ml-auto space-x-2 sm:space-x-3">
                     ...
                     <a href="{{ route('form-pegawai-surat-tugas') }}" type="button"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <a href="{{ url('hapus_surat_tugas/' .$m->id ) }}" data-modal-hide="popup-modal" type="button" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center me-2">
                    Hapus
                </a>
