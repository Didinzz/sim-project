...
@section('title', 'Surat Home Visit')
@section('content')
    <!-- component -->
    <section
        ...
        <form action="{{ route('store-pegawai-surat-home-visit') }}" method="POST" enctype="multipart/form-data">
            @csrf
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                    ...
                    <input required id="passwordConfirmation" name="nomor_paket" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" placeholder="Nomro Paket">
                </div>
                 ...
                 <div class="col-span-6 sm:col-span-3 hidden">
                    ...
                    <input id="text" name="tipeSurat" type="text"
                        class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 focus:border-slate-500  focus:outline-none focus:ring" value="Surat Home Visit">
                </div>
            ...
            <div class=" pt-3 w-full">
                <div class="broder-t-4 border-y-black pt-2 pb-3">
                    <hr class="font-bold broder-t-4 border-y-black dark:border-gray-300">
    
                </div>
                <h2 class="text-2xl font-bold text-black text-left capitalize mb-5 dark:text-white">Surat Home Visit</h2>
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="first-name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kelas/Kompetensi Keahlian</label>
                        <input type="text" name="kelas" id="first-name"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Kelas/Kompetensi" required>
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="first-name"
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <label for="first-name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hari/Tanggal Kunjungan</label>
                        <input type="text" name="tanggalKunjungan" id="first-name"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Hari/Tanggal Kunjungan" required>
                    </div>
                </div>
